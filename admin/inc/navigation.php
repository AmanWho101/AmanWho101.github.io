        ...
        <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
          ...
          <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link tree-item nav-transaction nav-deposit nav-withdraw nav-transfer nav-loan">
                ...
                <ul class="nav nav-treeview" style="">
                  ...
                  <li class="nav-item">
                    <a href="./?page=transaction/share" class="nav-link nav-share">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Axion/Share</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview" style="">
                      ...
                      <li class="nav-item"><a href="./?page=loan/takeloan" class="nav-link nav-takeloan">
